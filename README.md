...
> **Insight**: 증가율보다 감소율이 높습니다. 물가 상승으로 인한 고정비(교통비, 교육비) 지출 증가가 원인으로 보입니다.

### 2) 업종별 증가 소비 분석
![alt text](image-6.png)
> **Insight**: 유통업, 학원, 사무통신/서적 영역에서 대부분의 소비 증가가 이루어졌습니다. 
> 자녀들과 같이 이루어지는 형태의 고정비가 다수로, 다음과 같은 분야에 할인이 적용되는 것이 잠재 고객의 높은 유치가 가능할 것으로 보입니다.
